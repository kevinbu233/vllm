...
class FixedRejectionSampler(RejectionSampler):
    ...
    def _batch_modified_rejection_sampling(
        ...
        num_true = int(k * percent_accept)
                
        accepted = torch.zeros((batch_size, k), dtype=torch.bool)

        accepted[:, :num_true] = True
